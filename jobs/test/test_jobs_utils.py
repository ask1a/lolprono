        ...
        {'league_name':
            [
                ...
                'team_2': ['AL.Y', 'ANC', 'OMG.A', 'TT.Y', 'BJK', 'PNG.A', 'JJH', 'EDGY', 'LNGA', 'JDM',
                        ...
                        'CVN'],
                'game_date': [Timestamp('2024-04-28'), Timestamp('2024-04-28'),
                    Timestamp('2024-04-28'), Timestamp('2024-04-28'),
                    Timestamp('2024-04-28'), Timestamp('2024-04-28'),
                    Timestamp('2024-04-29'), Timestamp('2024-04-29'),
                    Timestamp('2024-04-29'), Timestamp('2024-04-30'),
                    Timestamp('2024-04-30'), Timestamp('2024-04-30'),
                    Timestamp('2024-05-01'), Timestamp('2024-05-01'),
                    Timestamp('2024-05-01'), Timestamp('2024-05-01'),
                    Timestamp('2024-05-01'), Timestamp('2024-05-02'),
                    Timestamp('2024-05-02'), Timestamp('2024-05-02'),
                    Timestamp('2024-05-02'), Timestamp('2024-05-02'),
                    Timestamp('2024-05-03'), Timestamp('2024-05-03'),
                    Timestamp('2024-05-03'), Timestamp('2024-05-03'),
                    Timestamp('2024-05-03'), Timestamp('2024-05-04'),
                    Timestamp('2024-05-04'), Timestamp('2024-05-04'),
                    Timestamp('2024-05-04'), Timestamp('2024-05-04'),
                    Timestamp('2024-05-05'), Timestamp('2024-05-05'),
                    Timestamp('2024-05-05'), Timestamp('2024-05-05'),
                    Timestamp('2024-05-05'), Timestamp('2024-05-06'),
                    Timestamp('2024-05-06'), Timestamp('2024-05-06'),
                    Timestamp('2024-05-07'), Timestamp('2024-05-07'),
                    Timestamp('2024-05-07'), Timestamp('2024-05-07'),
                    Timestamp('2024-05-07'), Timestamp('2024-05-07')]
            }
        )
